...
public class Cell2Listener implements MouseListener{
	...
	public Cell2Listener(BoardPanel panel, GameBoard board, int tileId, CellPanel thisCell,MainFrame frame) {
		this.panel = panel;
		this.board = board;
		this.tileId = tileId;
